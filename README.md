...
2. выделяешь фио авторов
    2. если авторов несколько, выделяешь всех одним выделением
    2. если слева и справа от названия указаны авторы, выделяешь обе группы
    2. Не выделяешь то, что не является именем автора, например, "и др" или "под редакцией/руководством Василия П."

3. выделяешь название
    3. если название заключено в кавычки, выделяешь то, что внутри кавычек
    3. если название включает в себя текст, заключённый в кавычки, то их тоже выделяешь

4. выделяешь год публикации
    4. не выделяешь "г" в записи, только число

4. выделяешь название журнала
    4. единственный чёткий критерий - слово "журнал"
    4. названия могут быть замысловатые, если название похоже на название журнала, тыкай журнал
    4. если увидешь два куска текста, похожих на название журнала, выбирай первое
    4. если название содержит слова ": интернет-журнал", ": журнал",  выделяй всё

5. выделяешь название конференции
    4. единственный чёткий критерий - слово "конференция"
    4. названия могут быть замысловатые, выделяй, если название похоже на название конференции
    4. если увидешь два куска текста, похожих на название журнала, выбирай первое
    4. если название содержит слова ": интернет-конференция", ": конференция",  выделяй всё
    5. если написано типа "материалы международной конференции Международная конференция", выделяй всё

6. выделяешь страницы
интересует информация, по которой можно определить расположение цитируемой информации
    6. не выделяй, если написано число страниц, например "7с
    6. выделяй, если написан диапазон страниц, например "С. 3-11", выделяй  целиком
    6. выделяй, если написано "С. 3", выделяй целиком 

7. выделяешь DOI

8. выделяешь URL
    8. выделяешь только ссылку, то есть то, по чему можно клинкнуть и перейти на сайт

9. выделяешь том
    9. если видишь "Том 1" или "Том №1", выделяешь всё

10. выделяешь номер
    10. номер, вероятно то, что стоит особняком и выглядит аналогично " -№ 4"
    10. слова наподобие "Выпуск номер" не выделяй, я пока не знаю, как это интерпретировать

11. выделяешь издательство
    11. выделяй, если написано "издатаельство" или "изд"
    11. выделяй, если это стоит ближе к концу, и похоже на название или название вуза

12. выделяй место издания
я решил, что это город
    12. выделяй, если написано "М." или "М"
    12. выделяй, если написан топоним
    12. выделяй, если написано несколько топонимов, например "Украина, Ялта-Гурзув"

13. выделяй ISBN
    13. выделяй "ISBN: " и код вместе

14. выделяй ISSN
    14. выделяй "ISSN: " и код вместе
